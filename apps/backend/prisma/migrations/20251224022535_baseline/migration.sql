...
-- CreateIndex
CREATE UNIQUE INDEX "ConeType_name_key" ON "ConeType"("name" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "Cut_name_key" ON "Cut"("name" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "InboundItem_barcode_key" ON "InboundItem"("barcode" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "IssueToConingMachine_barcode_key" ON "IssueToConingMachine"("barcode" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "IssueToCutterMachine_barcode_key" ON "IssueToCutterMachine"("barcode" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "IssueToHoloMachine_barcode_key" ON "IssueToHoloMachine"("barcode" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "Lot_lotNo_key" ON "Lot"("lotNo" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "ReceiveFromConingMachineRow_barcode_key" ON "ReceiveFromConingMachineRow"("barcode" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "ReceiveFromCutterMachineRow_vchNo_key" ON "ReceiveFromCutterMachineRow"("vchNo" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "ReceiveFromHoloMachineRow_barcode_key" ON "ReceiveFromHoloMachineRow"("barcode" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "Role_key_key" ON "Role"("key" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "RollType_name_key" ON "RollType"("name" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "StickerTemplate_stageKey_key" ON "StickerTemplate"("stageKey" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "Twist_name_key" ON "Twist"("name" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "User_username_key" ON "User"("username" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "UserSession_tokenHash_key" ON "UserSession"("tokenHash" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "WhatsappTemplate_event_key" ON "WhatsappTemplate"("event" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "Wrapper_name_key" ON "Wrapper"("name" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "Yarn_name_key" ON "Yarn"("name" ASC);

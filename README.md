...
- `GLINTEX_AGENT_READ_TOKEN` and `GLINTEX_AGENT_READ_PERMISSIONS` – optional,
  fail-closed credentials and base READ scopes for the dedicated GLINTEX
  OpenClaw companion. See `integrations/openclaw/README.md` before enabling.
